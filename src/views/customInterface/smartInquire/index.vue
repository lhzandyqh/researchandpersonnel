...
<!--        <HR width=1100 color=#dcdfe6 SIZE=1 align="right" />-->
        ...
        <el-row  style="margin-top: 3vh">
          <span style="font-size: 0.95rem;font-weight: bolder;float:left;margin-right: 10px;margin-left: 135.5px">项目级别</span>
        ...
        <el-row  style="margin-top: 3vh">
          <span style="font-size: 0.95rem;font-weight: bolder;float:left;margin-right: 10px;margin-left: 135.5px">项目资金</span>
