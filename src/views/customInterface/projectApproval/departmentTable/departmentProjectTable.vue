<template>
  <div class="app-container">
    <el-table
      ...
      <el-table-column align="center" label="操作">
        <template slot-scope="scope">
          <el-button type="primary" size="small" icon="el-icon-zoom-in" @click="getAuditing(scope.row.id,scope.row.type)">审核</el-button>
        </template>
      </el-table-column>
    </el-table>
    <div class="fenye">
    ...
    <el-dialog :visible.sync="xiangmudialogVisible" title="科研项目审核详情">
      <el-table :data="bData" fit highlight-current-row style="width: 100%">
        <el-table-column prop="renshu" label="项目人数"/>
        <el-table-column prop="jibie" label="项目级别"/>
        <el-table-column prop="bumen" label="主管部门"/>
        <!--<el-table-column prop="certType" label="证书颁发日期"/>-->
        <el-table-column prop="fuzeren" label="项目负责人"/>
        <el-table-column prop="yusuan" label="项目预算"/>
        <el-table-column prop="renshu" label="项目人数"/>
        <el-table-column align="center" label="项目方案">
          <template slot-scope="scope">
            <el-button type="text" size="medium" @click="lookImages(scope.$index)">查看附件</el-button>
          </template>
        </el-table-column>
        <el-table-column label="审核状态" align="center">
          <template slot-scope="scope">
